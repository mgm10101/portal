// src/components/Students/masterlist/EditFieldsModal.tsx
...
export const EditFieldsModal: React.FC<EditFieldsModalProps> = ({
  ...
  const handleDelete = async (field_id: string) => {
    ...
    const col = def.field_id;  // “custom_text1”, “custom_date2”, etc.

    // 3) Clear that single column across all students
    ...
    // 4) Delete the definition from custom_fields
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-800">Edit Custom Fields</h2>
          <button
            type="button"
            onClick={onClose}
